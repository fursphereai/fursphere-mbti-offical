...
const Question10: React.FC<Question10Props> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Routin_Curiosity.react_new_environment) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Routin_Curiosity', 'react_new_environment', getReactionText(parseInt(option)));
  };

  const handleNextPage16 = () => {
    if (surveyData.personality_and_behavior.Routin_Curiosity.react_new_environment !== '5' && surveyData.personality_and_behavior.Routin_Curiosity.react_new_environment !== '') {
      handleNext(); 
    }   
  };

  const getNextButtonColor = () => {
    return surveyData.personality_and_behavior.Routin_Curiosity.react_new_environment !== '5' 
    && surveyData.personality_and_behavior.Routin_Curiosity.react_new_environment !== ''
  ...
  <div className=" mx-auto w-[320px] md:w-[540px] flex flex-row items-center justify-between ">
    ...
    <div className="quiz-container">
      ...
      <div className="question-container h-[38px] md:h-[44px] leading-[19.36px] text-[#101828]">
        <h2>How does your pet behave in new environment?</h2>
      </div>
