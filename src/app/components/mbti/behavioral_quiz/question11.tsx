...
const Question11: React.FC<Question11Props> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Decision_Making.respond_to_scold) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Decision_Making', 'respond_to_scold', getReactionText(parseInt(option)));
  };

  const handleNextPage17 = () => {
    if (surveyData.personality_and_behavior.Decision_Making.respond_to_scold !== '5' && surveyData.personality_and_behavior.Decision_Making.respond_to_scold !== '') {
      handleNext(); 
    } 
  };

  const getNextButtonColor = () => {
    return surveyData.personality_and_behavior.Decision_Making.respond_to_scold !== '5' 
    && surveyData.personality_and_behavior.Decision_Making.respond_to_scold !== ''
  ...
  <div className=" mx-auto w-[320px] md:w-[540px] flex flex-row items-center justify-between ">
    ...
    <div className="quiz-container">
      ...
      <div className="question-container h-[38px] md:h-[44px] leading-[19.36px] text-[#101828]">
        <h2>When you scold your pet for misbehaving—how does he/she respond?</h2>
      </div>
