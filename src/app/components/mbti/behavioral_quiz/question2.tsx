...
const Question2: React.FC<Question2Props> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Routin_Curiosity.interact_with_toys) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Routin_Curiosity', 'interact_with_toys', getReactionText(parseInt(option)));
  };

  const handleNextPage8 = () => {
    
    if (surveyData.personality_and_behavior.Routin_Curiosity.interact_with_toys !== '5' && surveyData.personality_and_behavior.Routin_Curiosity.interact_with_toys !== '') {
      handleNext(); 
    } 
  };

  const getNextButtonColor = () => {
    return surveyData.personality_and_behavior.Routin_Curiosity.interact_with_toys !== '5' 
      && surveyData.personality_and_behavior.Routin_Curiosity.interact_with_toys !== ''
