...
const Question4: React.FC<Question4Props> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
      getReactionNumber(surveyData.personality_and_behavior.Structure_Spontaneity.prefer_routine) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Structure_Spontaneity', 'prefer_routine', getReactionText(parseInt(option)));
  };

  const handleNextPage10 = () => {
    
    if (surveyData.personality_and_behavior.Structure_Spontaneity.prefer_routine !== '5' && surveyData.personality_and_behavior.Structure_Spontaneity.prefer_routine !== '') {
      handleNext(); 
    } 
  };

  const getNextButtonColor = () => {
    return surveyData.personality_and_behavior.Structure_Spontaneity.prefer_routine !== '5' 
    && surveyData.personality_and_behavior.Structure_Spontaneity.prefer_routine !== ''
