...
const Question5: React.FC<Question5Props> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Energy_Socialization.friend_visit_behaviors) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Energy_Socialization', 'friend_visit_behaviors', getReactionText(parseInt(option)));
  };

  const handleNextPage11 = () => {
    
    if (surveyData.personality_and_behavior.Energy_Socialization.friend_visit_behaviors !== '5' && surveyData.personality_and_behavior.Energy_Socialization.friend_visit_behaviors !== '') {
      handleNext(); 
    } 
  };

  const getNextButtonColor = () => {
    return surveyData.personality_and_behavior.Energy_Socialization.friend_visit_behaviors !== '5' 
    && surveyData.personality_and_behavior.Energy_Socialization.friend_visit_behaviors !== ''
