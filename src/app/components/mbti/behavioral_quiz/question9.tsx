...
const Question9: React.FC<Question9Props> = ({
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Energy_Socialization.react_new_friend) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Energy_Socialization', 'react_new_friend', getReactionText(parseInt(option)));
  };

  const handleNextPage15 = () => {
    
    if (surveyData.personality_and_behavior.Energy_Socialization.react_new_friend !== '5' && surveyData.personality_and_behavior.Energy_Socialization.react_new_friend !== '') {
      handleNext(); 
    } 
  };

  const getNextButtonColor = () => {
    return surveyData.personality_and_behavior.Energy_Socialization.react_new_friend !== '5' 
    && surveyData.personality_and_behavior.Energy_Socialization.react_new_friend !== ''
