...
<motion.div 
    className="md:hidden mt-0  relative w-full mx-auto h-[793px]  bg-[#FFFFFF] flex flex-col items-center"
>
          ...
          <div className="relative  w-full h-full flex flex-col items-center ">
            ...
            <div className=" mt-[20px] text-[24px] font-[Ubuntu] font-[600] text-[#505D90]">
              ...
              <motion.div
                className="w-[800px] h-[1000px] absolute top-[-230px] z-[1] "
                drag="x"
          ...
          <div className="absolute top-[485px] flex gap-[20px]">
            {[...Array(totalPages)].map((_, index) => (
              <div
                key={index}
          ...
          <div className="absolute top-[520px] flex flex-row items-center justify-center z-[2]">
