...
<>   
    ...
    >
      ...
      <motion.div  className="relative bg-white bg-yellow-300 w-full md:w-[768px] h-full md:h-[563px] rounded-[0px] md:rounded-[22px] flex flex-col "
        ...
        <div className="bg-blue-300 flex flex-col items-center justify-center w-auto h-auto mt-[0px] md:mt-[80px]">
           {/* //header */}
           <div className="
           ...
           {/* //logo */}
          <div className="text-[32px] md:text-[48px] font-[Ubuntu] font-[500] text-[#505D90] leading-[38.4px] md:leading-[57.6px] mt-[40px] md:mt-[0px]">
            <h2>🐾</h2>
          </div>
